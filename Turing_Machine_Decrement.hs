--This is the Decrement Turing Machine for problem 11.2b
-- we can test this program , for example, by calling run "$0111$", and we get "$0110$."
...
delta S4 tape
    ...
    | head tape '$' = delta S5 $ left $ write tape '$'
delta S5 tape = tape
